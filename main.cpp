...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Betchip-seeder\n"
...
static const string mainnet_seeds[] = {"seeder.betchip.io", ""};
static const string testnet_seeds[] = {"testnet-seed.betchip.io", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9444), true);
  }
  do {
